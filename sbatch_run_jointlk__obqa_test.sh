#!/bin/env bash
#SBATCH -J obqa_jointlk_test                # 作业名 
#SBATCH -o log.obqa_jointlk_test.txt        # 屏幕上的输出文件重定向到 test.out
...
for seed in 0; do
  python3 -u eval_jointlk.py --dataset $dataset \
      --mode eval_detail \
      --inhouse False \
      --load_model_path saved_models/obqa/obqa.model.pt.dev_68.8-test_70.4 \
